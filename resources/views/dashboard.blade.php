...
<head>
    ...
    <style>
        ...
        #map-heatmap {
            ...
            width: 100%;
            z-index: 1;
            /* Garante que elementos do mapa não fiquem por cima do dropdown da navbar */
        }
    </style>
</head>
...
<body>
    ...
    <main class="container mx-auto px-4 pb-12 max-w-7xl flex flex-col gap-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <a href="{{ route('reports.index') }}" class="bg-white rounded-2xl shadow-sm p-6 border-2 border-green-100 hover:border-green-400 hover:shadow-lg transition-all text-decoration-none">
                <div class="flex items-center gap-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm hover:shadow-xl p-6 transition-all">
                ...
                <div class="text-center pt-2">
                    ...
                    <p class="text-sm text-gray-500 fw-medium">
            ...
            <div class="bg-white rounded-2xl shadow-sm hover:shadow-xl p-6 transition-all  h-[400px]">
                ...
                <div class="space-y-3 overflow-scroll h-[240px]">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
            ...
            <div class="bg-white rounded-2xl shadow-sm hover:shadow-xl p-6 transition-all flex flex-col justify-between">
                <div>
                    ...
                    <div class="text-center">
                        <p class="text-5xl font-bold text-orange-600 mb-2">{{ $highScoreMatchings }}</p>
                        ...
                        <div class="bg-orange-50 rounded-xl p-4 mb-6 border border-orange-100">
                            ...
                            <div class="flex flex-wrap gap-2 justify-center">
                                ...
                                <span class="bg-white border border-orange-200 text-orange-800 px-3 py-1.5 rounded-lg text-xs font-semibold shadow-sm">📍 {{ $region->city }}</span>
                                @endforeach
                            </div>
                        </div>
                    </div>
