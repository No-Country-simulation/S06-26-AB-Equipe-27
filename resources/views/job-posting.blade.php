...
<head>
    ...
    <title>Publicar nova vaga | SkillFocus</title>
...
<body>
    ...
    <div class="main-container">
        <div class="form-card">
            <h1 class="fw-bold mb-2 font-display" style="font-size: 1.85rem; color: var(--color-ink);">
                Criar nova vaga.
            </h1>
            <p class="text-muted mb-5" style="font-size: 0.9375rem;">
                Preencha os dados abaixo para postar uma nova oportunidade.
            </p>
